...
func (_u *CategoryUpdate) SetWeight(v int) *CategoryUpdate {
...
func (_u *CategoryUpdate) SetNillableWeight(v *int) *CategoryUpdate {
	if v != nil {
		_u.SetWeight(*v)
	}
	return _u
...
func (_u *CategoryUpdate) AddWeight(v int) *CategoryUpdate {
...
func (_u *CategoryUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Weight(); ok {
		_spec.SetField(category.FieldWeight, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedWeight(); ok {
		_spec.AddField(category.FieldWeight, field.TypeInt, value)
	}
...
// SetWeight sets the "weight" field.
func (_u *CategoryUpdateOne) SetWeight(v int) *CategoryUpdateOne {
	_u.mutation.ResetWeight()
	_u.mutation.SetWeight(v)
	return _u
}
...
// SetNillableWeight sets the "weight" field if the given value is not nil.
func (_u *CategoryUpdateOne) SetNillableWeight(v *int) *CategoryUpdateOne {
	if v != nil {
		_u.SetWeight(*v)
	}
	return _u
...
// AddWeight adds value to the "weight" field.
func (_u *CategoryUpdateOne) AddWeight(v int) *CategoryUpdateOne {
	_u.mutation.AddWeight(v)
	return _u
}
