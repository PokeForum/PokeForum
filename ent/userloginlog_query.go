...
func (_q *UserLoginLogQuery) QueryUser() *UserQuery {
...
func (_q *UserLoginLogQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserLoginLogQuery) FirstIDX(ctx context.Context) int {
...
func (_q *UserLoginLogQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UserLoginLogQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *UserLoginLogQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *UserLoginLogQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UserLoginLogQuery) WithUser(opts ...func(*UserQuery)) *UserLoginLogQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *UserLoginLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserLoginLog, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *UserLoginLog, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserLoginLogQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserLoginLog, init func(*UserLoginLog), assign func(*UserLoginLog, *User)) error {
...
func (_q *UserLoginLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userloginlog.Table, userloginlog.Columns, sqlgraph.NewFieldSpec(userloginlog.FieldID, field.TypeInt))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(userloginlog.FieldUserID)
		}
	}
