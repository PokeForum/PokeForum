...
func ModuleEQ(v Module) predicate.Settings {
	return predicate.Settings(sql.FieldEQ(FieldModule, v))
}

// ModuleNEQ applies the NEQ predicate on the "module" field.
func ModuleNEQ(v Module) predicate.Settings {
	return predicate.Settings(sql.FieldNEQ(FieldModule, v))
}

// ModuleIn applies the In predicate on the "module" field.
func ModuleIn(vs ...Module) predicate.Settings {
	return predicate.Settings(sql.FieldIn(FieldModule, vs...))
}

// ModuleNotIn applies the NotIn predicate on the "module" field.
func ModuleNotIn(vs ...Module) predicate.Settings {
	return predicate.Settings(sql.FieldNotIn(FieldModule, vs...))
}
...
func ValueTypeEQ(v ValueType) predicate.Settings {
	return predicate.Settings(sql.FieldEQ(FieldValueType, v))
}

// ValueTypeNEQ applies the NEQ predicate on the "value_type" field.
func ValueTypeNEQ(v ValueType) predicate.Settings {
	return predicate.Settings(sql.FieldNEQ(FieldValueType, v))
}

// ValueTypeIn applies the In predicate on the "value_type" field.
func ValueTypeIn(vs ...ValueType) predicate.Settings {
	return predicate.Settings(sql.FieldIn(FieldValueType, vs...))
}

// ValueTypeNotIn applies the NotIn predicate on the "value_type" field.
func ValueTypeNotIn(vs ...ValueType) predicate.Settings {
	return predicate.Settings(sql.FieldNotIn(FieldValueType, vs...))
}
