...
// The CategoryModeratorFunc type is an adapter to allow the use of ordinary
// function as CategoryModerator mutator.
type CategoryModeratorFunc func(context.Context, *ent.CategoryModeratorMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CategoryModeratorFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CategoryModeratorMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CategoryModeratorMutation", m)
}
...
// The CommentActionFunc type is an adapter to allow the use of ordinary
// function as CommentAction mutator.
type CommentActionFunc func(context.Context, *ent.CommentActionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CommentActionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CommentActionMutation); ok {
		return f(ctx, mv)
	}
...
// The PostActionFunc type is an adapter to allow the use of ordinary
// function as PostAction mutator.
type PostActionFunc func(context.Context, *ent.PostActionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PostActionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PostActionMutation); ok {
		return f(ctx, mv)
	}
...
// The UserBalanceLogFunc type is an adapter to allow the use of ordinary
// function as UserBalanceLog mutator.
type UserBalanceLogFunc func(context.Context, *ent.UserBalanceLogMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserBalanceLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserBalanceLogMutation); ok {
		return f(ctx, mv)
	}
