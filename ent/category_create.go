...
func (_c *CategoryCreate) SetWeight(v int) *CategoryCreate {
	_c.mutation.SetWeight(v)
	return _c
}

// SetNillableWeight sets the "weight" field if the given value is not nil.
func (_c *CategoryCreate) SetNillableWeight(v *int) *CategoryCreate {
	if v != nil {
		_c.SetWeight(*v)
	}
	return _c
...
func (_c *CategoryCreate) check() error {
	...
	if _, ok := _c.mutation.Weight(); !ok {
		return &ValidationError{Name: "weight", err: errors.New(`ent: missing required field "Category.weight"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
