...
type Settings struct {
	...
	Module settings.Module `json:"module,omitempty"`
	// Key holds the value of the "key" field.
	Key string `json:"key,omitempty"`
	// Value holds the value of the "value" field.
	Value string `json:"value,omitempty"`
	// ValueType holds the value of the "value_type" field.
	ValueType    settings.ValueType `json:"value_type,omitempty"`
...
func (*Settings) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case settings.FieldModule, settings.FieldKey, settings.FieldValue, settings.FieldValueType:
	...
	for i := range columns {
		...
		case settings.FieldModule:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.Module = settings.Module(value.String)
			}
		...
		case settings.FieldValueType:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.ValueType = settings.ValueType(value.String)
			}
		default:
