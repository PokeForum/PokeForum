...
type CategoryCreateRequest struct {
	...
	Status      string `json:"status" binding:"required,oneof=Normal LoginRequired MemberOnly Hidden Locked" example:"Normal"` // 版块状态
}
...
type CategoryUpdateRequest struct {
	...
	Status      string `json:"status" binding:"omitempty,oneof=Normal LoginRequired MemberOnly Hidden Locked" example:"Normal"` // 版块状态
}
