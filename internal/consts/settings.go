...
const (
	// InvitationCodeIsEnable Whether to enable invitation code | 是否启用邀请码
	InvitationCodeIsEnable = "invitation_code:is_enable"
	// InvitationCodeMode Invitation code mode: direct, points, currency | 邀请码模式：直接, 积分, 货币
