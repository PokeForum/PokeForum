...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/moderator/categories/announcement": {
            "post": {
        ...
        "/api/v1/moderator/categories/{category_id}/announcements": {
            "get": {
        ...
        "/api/v1/moderator/posts/essence": {
            "put": {
