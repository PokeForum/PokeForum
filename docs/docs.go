    ...
    "paths": {
        ...
        "/manage/reports/batch-handle": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Batch handle request | 批量处理请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ReportBatchHandleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/manage/reports/handle": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Handle report request | 处理举报请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ReportHandleRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.ReportHandleResponse"
                                        }
                                    }
                                }
                            ]
                    ...
                    "404": {
                        "description": "Report not found | 举报不存在",
                        "schema": {
                            "$ref": "#/definitions/response.Data"
                        }
                    },
                    "409": {
                        "description": "Already handled | 已被处理",
                        "schema": {
                            "$ref": "#/definitions/response.Data"
                        }
                    },
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "Status filter | 状态筛选",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        ...
                        "type": "string",
                        "description": "Target type filter | 目标类型筛选",
                        "name": "target_type",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Report type filter | 举报类型筛选",
                        "name": "report_type",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Reporter ID filter | 举报者ID筛选",
                        "name": "reporter_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Target author ID filter | 被举报作者ID筛选",
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.ReportStatsResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.CommentCountRankingResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.CurrencyRankingResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.FollowerRankingResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.PointsRankingResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.PostCountRankingResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.ReadingRankingResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/reports": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Create report request | 创建举报请求",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.ReportCreateResponse"
                                        }
                                    }
                                }
                            ]
                    ...
                    "404": {
                        "description": "Target not found | 目标不存在",
                        "schema": {
                            "$ref": "#/definitions/response.Data"
                        }
                    },
                    "409": {
                        "description": "Already reported | 已举报过",
                        "schema": {
                            "$ref": "#/definitions/response.Data"
                        }
                    },
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.UserReportListResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "schema.CommentCountRankingItem": {
            ...
            "properties": {
                ...
                "total_comments": {
                    "description": "Total comments | 评论总数",
                    "type": "integer"
                },
                "total_likes": {
                    "description": "Total likes | 获赞总数",
                    "type": "integer"
                },
                "user_id": {
                    "description": "User ID | 用户ID",
        ...
        "schema.FollowerRankingItem": {
            ...
            "properties": {
                ...
                "total_followers": {
                    "description": "Total followers | 粉丝总数",
                    "type": "integer"
                },
                "total_posts": {
                    "description": "Total posts | 帖子总数",
                    "type": "integer"
                },
                "user_id": {
                    "description": "User ID | 用户ID",
        ...
        "schema.ReportCreateRequest": {
            ...
            "properties": {
                "reason": {
                    "description": "Detailed reason (supports Markdown) | 详细原因（支持 Markdown）",
                    "type": "string",
                    "maxLength": 5000,
                    "example": "This post contains spam content. See details: [link](url)"
                },
                "report_type": {
                    "description": "Report type: spam/harassment/inappropriate/illegal/plagiarism/other | 举报类型",
                    "type": "string",
                    "enum": [
                        "spam",
                        "harassment",
                ...
                "target_id": {
                    "description": "Target ID | 被举报目标ID",
                    "type": "integer",
                    "minimum": 1,
                    "example": 1
                },
                "target_type": {
                    "description": "Target type: post/comment/user | 目标类型",
                    "type": "string",
                    "enum": [
                        "post",
                        "comment",
        ...
        "schema.ReportCreateResponse": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "Report ID | 举报ID",
                    "type": "integer",
                    "example": 1
                },
                "status": {
                    "description": "Report status | 举报状态",
                    "type": "string",
                    "example": "pending"
                }
            }
        ...
        "schema.ReportHandleRequest": {
            ...
            "properties": {
                "action": {
                    "description": "Action: delete/warn/ban/ignore | 动作",
                    "type": "string",
                    "enum": [
                        "delete",
                        "warn",
                ...
                "handle_result": {
                    "description": "Handle result description | 处理结果说明",
                    "type": "string",
                    "maxLength": 500,
                ...
                "notify_reporter": {
                    "description": "Whether to notify the reporter | 是否通知举报者",
                    "type": "boolean",
                    "example": true
                }
            }
        ...
        "schema.ReportListItem": {
            ...
            "properties": {
                ...
                "handle_action": {
                    "description": "Handle action | 处理动作",
                    "type": "string"
                },
                "handle_result": {
                    "description": "Handle result | 处理结果",
                    "type": "string"
                },
                "handled_at": {
                    "description": "Handled time | 处理时间",
                ...
                "handler_id": {
                    "description": "Handler ID | 处理人ID",
                    "type": "integer",
                    "example": 5
                },
                "handler_name": {
                    "description": "Handler name | 处理人名称",
                    "type": "string",
                    "example": "admin"
                },
                "id": {
                ...
                "reason": {
                    "description": "Reason (supports Markdown) | 原因（支持 Markdown）",
                    "type": "string",
                    "example": "Spam content with [evidence](url)"
                },
                "report_type": {
                    "description": "Report type | 举报类型",
                    "type": "string",
                    "example": "spam"
                },
                "reporter_id": {
                    "description": "Reporter ID | 举报者ID",
                    "type": "integer",
                    "example": 10
                },
                "reporter_name": {
                    "description": "Reporter name | 举报者名称",
                    "type": "string",
                    "example": "user123"
                },
                "status": {
                ...
                "target_author_id": {
                    "description": "Target author ID | 目标作者ID",
                    "type": "integer",
                    "example": 20
                },
                "target_author_name": {
                    "description": "Target author name | 目标作者名称",
                    "type": "string",
                    "example": "author456"
                },
                "target_content": {
                    "description": "Target content preview | 目标内容预览",
                    "type": "string",
                    "example": "Content preview..."
                },
                "target_id": {
                    "description": "Target ID | 目标ID",
                    "type": "integer",
                    "example": 100
                },
                "target_title": {
                    "description": "Target title | 目标标题",
                    "type": "string",
                    "example": "Post title"
                },
                "target_type": {
                    "description": "Target type | 目标类型",
                    "type": "string",
                    "example": "post"
                }
            }
        ...
        "schema.ReportListResponse": {
            ...
            "properties": {
                "list": {
                    "description": "Report list | 举报列表",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schema.ReportListItem"
                    }
                },
                "page": {
                    "description": "Page number | 页码",
        ...
        "schema.ReportStatsResponse": {
            ...
            "properties": {
                "by_type_stats": {
                    "description": "Statistics by type | 按类型统计",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schema.ReportStatsItem"
                    }
                },
                "ignored_count": {
                    "description": "Ignored count | 已忽略数",
                    "type": "integer"
                },
                "pending_count": {
                    "description": "Pending count | 待处理数",
                    "type": "integer"
                },
                "processing_count": {
                    "description": "Processing count | 处理中数",
                    "type": "integer"
                },
                "resolved_count": {
                    "description": "Resolved count | 已处理数",
                    "type": "integer"
                },
                "today_count": {
                    "description": "Today count | 今日举报数",
                    "type": "integer"
                },
                "total_reports": {
                    "description": "Total reports | 总举报数",
                    "type": "integer"
                }
            }
        },
        ...
        "schema.UserReportItem": {
            ...
            "properties": {
                ...
                "target_title": {
                    "description": "Target title (post title or comment preview) | 目标标题（帖子标题或评论摘要）",
                    "type": "string",
                    "example": "Post title"
                },
                "target_type": {
        ...
        "schema.UserReportListResponse": {
            ...
            "properties": {
                "list": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schema.UserReportItem"
                    }
                },
                "page": {
                    "description": "Page number | 页码",
